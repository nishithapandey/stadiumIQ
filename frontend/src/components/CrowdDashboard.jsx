      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
          >
      ...
      {loading && gates.length === 0 ? (
        ...
        <ul className="space-y-3" role="list" aria-label={t("gate_statuses")}>
          {gates.map((gate) => {
            ...
            return (
              <li key={gate.gate} className="bg-slate-800 rounded-xl p-4">
